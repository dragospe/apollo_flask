...
ACTIVITY_TYPE_ENUM = Enum(
    'UNCATEGORIZED', 'SEDENTARY', 'SLEEP', 'RUNNING',
    'STREET_RUNNING', 'TRACK_RUNNING', 'TRAIL_RUNNING', 'TREADMILL_RUNNING',
    'CYCLING', 'GENERIC', 'CYCLOCROSS', 'DOWNHILL_BIKING', 'INDOOR_CYCLING',
    ...
    'OPEN_WATER_SWIMMING', 'WALKING', 'CASUAL_WALKING', 'SPEED_WALKING',
    'TRANSITION', 'SWIMTOBIKETRANSITION', 'BIKETORUNTRANSITION',
    'RUNTOBIKETRANSITION', 'MOTORCYCLING', 'OTHER',
    'BACKCOUNTRY_SKIING_SNOWBOARDING', 'BOATING', 'CROSS_COUNTRY_SKIING',
    'DRIVING_GENERAL', 'FLYING', 'GOLF', 'HORSEBACK_RIDING', 'INLINE_SKATING',
    'MOUNTAINEERING', 'PADDLING', 'RESORT_SKIING_SNOWBOARDING', 'ROWING',
