...
class Activity_Summary(Base):
    ...
    number_of_active_lengths = Column(
        Integer,
    ...
    elevation_gain_total_meters = Column(
        Float,
        CheckConstraint("elevation_gain_total_meters >= 0"))

    elevation_loss_total_meters = Column(
        Float,
        CheckConstraint("elevation_loss_total_meters >= 0"))
